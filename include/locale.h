...
const char *tNames[1024][2]/*={{"OS Info","Reboot","Test panic","365 Editor","365 Brush"},{"Informacix ob OS","Perezagruzka","Test paniki","365 Redaktor","KistX 365"}};*/;
void setupLocale()
{
//small 'w' is Y
...
tNames[1][8]="        Kernel: " DISTNAME " v" VERSION ", Z Window System 1.2.0.        ";
tNames[1][9]="        Press left CTRL to display main menu, or F1 to show help.        ";
tNames[1][10]="Basic graphics editor";
tNames[1][11]="Basic text editor";
tNames[1][12]="Press F5 to exit. Files cannot be saved today.";
tNames[1][13]=DISTNAME " v" VERSION ", Z Window System 1.2.0. Press X to exit.";
...
tNames[1][19]="Clock";
tNames[1][20]="Calculator";
tNames[1][21]="Press 0 to F key to change the wallpaper color.";
tNames[1][22]="Thank you for getting " DISTNAME ".";
tNames[1][23]="ABOUT THIS SYSTEM";
tNames[1][24]=DISTNAME " is an operating system  written by Byte PowerSoft.";
tNames[1][25]="This is a version " VERSION ". Let's get started!";
tNames[1][26]="HELP";
tNames[1][27]="When the OS is booted, you will see the " DISTNAME " desktop. Now you can launch progs";
...
tNames[1][34]="ics Editor, OS Info, Authors.";
...
tNames[1][45]="Authors";
tNames[1][46]="Showing all " DISTNAME " development and helpers team.";
tNames[1][47]="We hope that you enjoy using our software. We are trying to make it better.";
tNames[1][48]="";
tNames[1][49]="                                                        Made by " DISTNAME " Dev Team";
...
tNames[1][58]=DISTNAME " Help System";
