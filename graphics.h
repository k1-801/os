...
void drawBitmap(char bm[],word x,word y,word width,word height,uint32_t bg,uint32_t c1,uint32_t c2,uint32_t c3,uint32_t c4,bool dnf=false)
{
	int i,j;
	//int sc1=0,sc2=0;
	i = 0;
...
void drawBitmap(char bm[],word x,word y,word width,word height)
{
	int i,j;
	i = 0;
	j = 0;
